...
<body <?php body_class(); ?>>
  <div class="w-full min-h-screen flex flex-col bg-neutral-300 text-neutral-700">
    <header class="mb-8">
        <div class="container px-4 mx-auto lg:w-4/5 lg:max-w-screen-md">
            <h1 class="text-4xl md:text-6xl"><a href="<?php echo home_url(); ?>"><?php bloginfo('name'); ?></a></h1>
        ...
        <div class="container grid gap-4 divide-dotted divide-neutral-700 divide-y px-4 mx-auto lg:w-4/5 lg:max-w-screen-md">
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                <article <?php post_class(); ?>>
                    <h2 class="text-3xl my-4"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
